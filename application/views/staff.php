...
$(document).ready(function() {
    ...
    $('#menu-header-title').text('Προσωπικό Φροντιστηρίου');
       ...
       <div class="row" >
        <div class="col-md-12">
          <div class="btn-toolbar" role="toolbar" style="margin-bottom:10px;">
            ...
            <button class="btn btn-sm btn-openpage pull-right" id="employee-card"><i class="icon-user"> </i> Καρτέλα Εργαζομένου</button>
          </div>
        </div>
        </div>
