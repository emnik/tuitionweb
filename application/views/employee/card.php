    ...
    <h3>
      ...
      <form action="<?php echo base_url()?>staff/card/<?php echo $employee['id']?>" method="post" accept-charset="utf-8">
          <div class="btn-group pull-right" data-toggle="buttons-radio">
            <button name="active" type="button" value='1' class="btn btn-small btn-primary <?php if($emplcard['active']==1) echo 'active';?>">Ενεργός</button>
            <button name="active" type="button" value='0' class="btn btn-small btn-primary <?php if($emplcard['active']==0) echo 'active';?>">Ανενεργός</button>
          </div>
     </div>
	            ...
	            <div class="content">
	        	    ...
	        	    <fieldset id="mainform"> <!-- disabled for enabling/disabling all form controls in the fieldset-->
	        	       <div class="row-fluid">	
	        	    		...
	        	    		<div class="span4">
	        	    			<label>Σύντομο Όνομα</label><input disabled class="span12" id="nickname" type="text" placeholder="για καθηγητές" name="nickname" value="<?php echo $emplcard['nickname'];?>">
	        	    		</div>
	        	    	</div>
	        	    ...
	        	    <fieldset id="mainform"> <!-- disabled for enabling/disabling all form controls in the fieldset-->
	        	       <div class="row-fluid">	
			              <div class="span4">
		                    ...
		                    <select class="span12" name="is_tutor" disabled >
