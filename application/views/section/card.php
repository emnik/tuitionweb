...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $('#newdaybtn').click(function() {
      ...
      //-------------set new classroom--------------- (if is just an input field)
      ...
      //-------------set new dayname--------------- (if it is a select field)
      selfields.eq(1).attr("name", "classroom_id[" + newdayindex + "]");
      selfields.eq(1).attr('id', "classroomid[" + newdayindex + "]");
      selfields.eq(1).find('option:selected').removeAttr("selected");
      selfields.eq(1).find('option:first-child').attr('selected', 'selected');
    });
    ...
    $('.timecontainer input').clockpicker({
        autoclose: true,
        minutestep: 5
        // 'default': '15:00'
    })
                        ...
                        <div class="col-md-3 col-xs-6">
                          ...
                          <select disabled id="classes" class="form-control" name="class_id">
                            ...
                            <?php foreach ($class as $data) : ?>
                              <option value="<?php echo $data['id'] ?>" <?php if ($sectioncard['class_id'] == $data['id']) {
                            ...
                            <select disabled id="courses" class="form-control" name="course_id">
                              <?php if ($course) : ?>
                                ...
                                <?php foreach ($course as $id => $value) : ?>
                                  <option value="<?php echo $id; ?>" <?php if ($sectioncard['course_id'] == $id) {
                                                                      echo 'selected="selected"';
                                                                      $sel = true;
                            ...
                            <select disabled id="lessons" class="form-control" name="lesson_id">
                              <?php if ($lesson) : ?>
                                ...
                                <?php foreach ($lesson as $id => $value) : ?>
                                  <option value="<?php echo $id; ?>" <?php if ($sectioncard['lesson_id'] == $id) {
                                                                      echo 'selected="selected"';
                                                                      $sel = true;
                                                                    } ?>><?php echo $value; ?></option>
                                <?php endforeach; ?>
                            ...
                            <select disabled id="tutors" class="form-control" name="tutor_id">
                              <?php if ($tutor) : ?>
                                ...
                                <?php foreach ($tutor as $id => $value) : ?>
                                  <option value="<?php echo $id; ?>" <?php if ($sectioncard['tutor_id'] == $id) {
                                                                      echo 'selected="selected"';
                                                                      $sel = true;
                                                                    } ?>><?php echo $value; ?></option>
                                <?php endforeach; ?>
                          ...
                          <div class="row programrow">
                            ...
                            <div class="col-sm-3 col-xs-4">
                              <div class="form-group">
                                ...
                                <select disabled id="classroomid[<?php echo $daysectionprog['id']; ?>]" class="form-control" name="classroom_id[<?php echo $daysectionprog['id']; ?>]">
                                  <?php echo "<option value=''></option>";?>
                                  <?php $sel = false; ?>
                                  <?php foreach ($classroom as $data) : ?>
                                    <option value="<?php echo $data['id'] ?>" <?php if ($daysectionprog['classroom_id'] == $data['id']) {
                                                                                echo 'selected="selected"';
                                                                                $sel = true;
                                                                              } ?>><?php echo $data['classroom']; ?></option>
                                  <?php endforeach; ?>
                                </select>
                              </div>
                            </div>
                        ...
                        <div class="row programrow">
                          ...
                          <div class="col-xs-3">
                            <div class="form-group">
                              ...
                              <select disabled id="classroomid[-1]" class="form-control" name="classroom_id[-1]">
                                  <?php echo "<option selected='selected' value=''></option>";?>
                                  <?php foreach ($classroom as $data) : ?>
                                    <option value="<?php echo $data['id'] ?>"> <?php echo $data['classroom']; ?> </option>
                                  <?php endforeach; ?>
                                </select>                            
                            </div>
                          </div>
